...
\item
	\ressubheading{Bharat Petroleum Corporation Limited}{Mumbai,India}{Posting in Gujarat}{2009 - 2010}
	\begin{itemize}
		\resitem{In the capacity of marketing officer managing the production department, I studied the various possibilites to reduce the overloading of motors that 
		run the chain conveyors. This resulted in the redisgn of a certain section of the conveyor belt and also the timely rewinding of a motor. It also lead to the
